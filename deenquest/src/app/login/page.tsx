    ...
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden" style={{ backgroundImage: "url('/kaaba-bg.png')", backgroundSize: "cover", backgroundPosition: "center" }}>
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="glass rounded-2xl shadow-2xl p-8">
          ...
          <button onClick={handleGoogle} className="glass-btn w-full flex items-center justify-center gap-3 mb-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" disabled={loading} className="glass-btn w-full py-3 disabled:opacity-50">
