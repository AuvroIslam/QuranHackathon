    ...
    <div className="relative min-h-screen flex items-center justify-center px-4">
      ...
      <div className="w-full max-w-md relative z-20">
        ...
        <div className="glass rounded-2xl shadow-2xl p-8">
          ...
          <button onClick={handleGoogle} className="glass-btn login-btn w-full flex items-center justify-center gap-3 mb-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {isSignUp && (
              <p className="text-xs text-white/40 leading-relaxed">
                ...
                <a href="/terms" target="_blank" className="text-accent underline hover:text-accent/80">Terms of Service</a>{" "}
                and{" "}
                <a href="/privacy" target="_blank" className="text-accent underline hover:text-accent/80">Privacy Policy</a>.
              </p>
            )}

            <button type="submit" disabled={loading} className="glass-btn login-btn w-full py-3 disabled:opacity-50">
          ...
          {!isSignUp && (
            <p className="text-center text-xs text-white/30 mt-4">
              ...
              <a href="/terms" target="_blank" className="text-accent/70 underline hover:text-accent">Terms of Service</a>{" "}
              &amp;{" "}
              <a href="/privacy" target="_blank" className="text-accent/70 underline hover:text-accent">Privacy Policy</a>.
            </p>
          )}
